...
#define LOW_PRECISION`),e}function SM(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===id?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===Zm?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===qn&&(e="SHADOWMAP_TYPE_VSM"),e}function EM(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case Rr:case Cr:e="ENVMAP_TYPE_CUBE";break;case uo:e="ENVMAP_TYPE_CUBE_UV";break}return e}function TM(n){let e="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case Cr:e="ENVMAP_MODE_REFRACTION";break}return e}function bM(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case rd:e="ENVMAP_BLENDING_MULTIPLY";break;case gg:e="ENVMAP_BLENDING_MIX";break;case _g:e="ENVMAP_BLENDING_ADD";break}return e}function AM(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:i,maxMip:t}}function wM(n,e,t,i){const r=n.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=SM(t),c=EM(t),u=TM(t),h=bM(t),f=AM(t),d=pM(t),m=mM(s),_=r.createProgram();let g,p,T=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+p);const E=T+g+a,M=T+p+o,R=kh(r,r.VERTEX_SHADER,E),P=kh(r,r.FRAGMENT_SHADER,M);r.attachShader(_,R),r.attachShader(_,P),t.index0AttributeName!==void 0?r.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(_,0,"position"),r.linkProgram(_);function b(w){if(n.debug.checkShaderErrors){const z=r.getProgramInfoLog(_).trim(),F=r.getShaderInfoLog(R).trim(),X=r.getShaderInfoLog(P).trim();let q=!0,G=!0;if(r.getProgramParameter(_,r.LINK_STATUS)===!1)if(q=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,_,R,P);else{const j=Hh(r,R,"vertex"),H=Hh(r,P,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(_,r.VALIDATE_STATUS)+`
...
Program Info Log: `+z+`
`+j+`
`+H)}else z!==""?console.warn("THREE.WebGLProgram: Program Info Log:",z):(F===""||X==="")&&(G=!1);G&&(w.diagnostics={runnable:q,programLog:z,vertexShader:{log:F,prefix:g},fragmentShader:{log:X,prefix:p}})}r.deleteShader(R),r.deleteShader(P),C=new Aa(r,_),S=gM(r,_)}let C;this.getUniforms=function(){return C===void 0&&b(this),C};let S;this.getAttributes=function(){return S===void 0&&b(this),S};let x=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return x===!1&&(x=r.getProgramParameter(_,oM)),x},this.destroy=function(){i.releaseStatesOfProgram(this),r.deleteProgram(_),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=lM++,this.cacheKey=e,this.usedTimes=1,this.program=_,this.vertexShader=R,this.fragmentShader=P,this}let RM=0;class CM{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,i=e.fragmentShader,r=this._getShaderStage(t),s=this._getShaderStage(i),a=this._getShaderCacheForMaterial(e);return a.has(r)===!1&&(a.add(r),r.usedTimes++),a.has(s)===!1&&(a.add(s),s.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const i of t)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let i=t.get(e);return i===void 0&&(i=new Set,t.set(e,i)),i}_getShaderStage(e){const t=this.shaderCache;let i=t.get(e);return i===void 0&&(i=new PM(e),t.set(e,i)),i}}class PM{constructor(e){this.id=RM++,this.code=e,this.usedTimes=0}}function LM(n,e,t,i,r,s,a){const o=new Ed,l=new CM,c=new Set,u=[],h=r.logarithmicDepthBuffer,f=r.vertexTextures;let d=r.precision;const m={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function _(S){return c.add(S),S===0?"uv":`uv${S}`}function g(S,x,w,z,F){const X=z.fog,q=F.geometry,G=S.isMeshStandardMaterial?z.environment:null,j=(S.isMeshStandardMaterial?t:e).get(S.envMap||G),H=j&&j.mapping===uo?j.image.height:null,ie=m[S.type];S.precision!==null&&(d=r.getMaxPrecision(S.precision),d!==S.precision&&console.warn("THREE.WebGLProgram.getParameters:",S.precision,"not supported, using",d,"instead."));const de=q.morphAttributes.position||q.morphAttributes.normal||q.morphAttributes.color,ee=de!==void 0?de.length:0;let te=0;q.morphAttributes.position!==void 0&&(te=1),q.morphAttributes.normal!==void 0&&(te=2),q.morphAttributes.color!==void 0&&(te=3);let we,W,J,he;if(ie){const Je=Tn[ie];we=Je.vertexShader,W=Je.fragmentShader}else we=S.vertexShader,W=S.fragmentShader,l.update(S),J=l.getVertexShaderID(S),he=l.getFragmentShaderID(S);const re=n.getRenderTarget(),Ee=n.state.buffers.depth.getReversed(),ze=F.isInstancedMesh===!0,be=F.isBatchedMesh===!0,pt=!!S.map,ht=!!S.matcap,Ve=!!j,L=!!S.aoMap,Zt=!!S.lightMap,Ge=!!S.bumpMap,We=!!S.normalMap,Me=!!S.displacementMap,at=!!S.emissiveMap,ye=!!S.metalnessMap,A=!!S.roughnessMap,v=S.anisotropy>0,O=S.clearcoat>0,K=S.dispersion>0,Z=S.iridescence>0,Y=S.sheen>0,xe=S.transmission>0,ce=v&&!!S.anisotropyMap,me=O&&!!S.clearcoatMap,qe=O&&!!S.clearcoatNormalMap,ne=O&&!!S.clearcoatRoughnessMap,ge=Z&&!!S.iridescenceMap,Ae=Z&&!!S.iridescenceThicknessMap,Ce=Y&&!!S.sheenColorMap,_e=Y&&!!S.sheenRoughnessMap,Xe=!!S.specularMap,Fe=!!S.specularColorMap,st=!!S.specularIntensityMap,I=xe&&!!S.transmissionMap,oe=xe&&!!S.thicknessMap,V=!!S.gradientMap,$=!!S.alphaMap,fe=S.alphaTest>0,ue=!!S.alphaHash,Ne=!!S.extensions;let ft=yi;S.toneMapped&&(re===null||re.isXRRenderTarget===!0)&&(ft=n.toneMapping);const bt={shaderID:ie,shaderType:S.type,shaderName:S.name,vertexShader:we,fragmentShader:W,defines:S.defines,customVertexShaderID:J,customFragmentShaderID:he,isRawShaderMaterial:S.isRawShaderMaterial===!0,glslVersion:S.glslVersion,precision:d,batching:be,batchingColor:be&&F._colorsTexture!==null,instancing:ze,instancingColor:ze&&F.instanceColor!==null,instancingMorph:ze&&F.morphTexture!==null,supportsVertexTextures:f,outputColorSpace:re===null?n.outputColorSpace:re.isXRRenderTarget===!0?re.texture.colorSpace:Ct,alphaToCoverage:!!S.alphaToCoverage,map:pt,matcap:ht,envMap:Ve,envMapMode:Ve&&j.mapping,envMapCubeUVHeight:H,aoMap:L,lightMap:Zt,bumpMap:Ge,normalMap:We,displacementMap:f&&Me,emissiveMap:at,normalMapObjectSpace:We&&S.normalMapType===Pg,normalMapTangentSpace:We&&S.normalMapType===_d,metalnessMap:ye,roughnessMap:A,anisotropy:v,anisotropyMap:ce,clearcoat:O,clearcoatMap:me,clearcoatNormalMap:qe,clearcoatRoughnessMap:ne,dispersion:K,iridescence:Z,iridescenceMap:ge,iridescenceThicknessMap:Ae,sheen:Y,sheenColorMap:Ce,sheenRoughnessMap:_e,specularMap:Xe,specularColorMap:Fe,specularIntensityMap:st,transmission:xe,transmissionMap:I,thicknessMap:oe,gradientMap:V,opaque:S.transparent===!1&&S.blending===Sr&&S.alphaToCoverage===!1,alphaMap:$,alphaTest:fe,alphaHash:ue,combine:S.combine,mapUv:pt&&_(S.map.channel),aoMapUv:L&&_(S.aoMap.channel),lightMapUv:Zt&&_(S.lightMap.channel),bumpMapUv:Ge&&_(S.bumpMap.channel),normalMapUv:We&&_(S.normalMap.channel),displacementMapUv:Me&&_(S.displacementMap.channel),emissiveMapUv:at&&_(S.emissiveMap.channel),metalnessMapUv:ye&&_(S.metalnessMap.channel),roughnessMapUv:A&&_(S.roughnessMap.channel),anisotropyMapUv:ce&&_(S.anisotropyMap.channel),clearcoatMapUv:me&&_(S.clearcoatMap.channel),clearcoatNormalMapUv:qe&&_(S.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:ne&&_(S.clearcoatRoughnessMap.channel),iridescenceMapUv:ge&&_(S.iridescenceMap.channel),iridescenceThicknessMapUv:Ae&&_(S.iridescenceThicknessMap.channel),sheenColorMapUv:Ce&&_(S.sheenColorMap.channel),sheenRoughnessMapUv:_e&&_(S.sheenRoughnessMap.channel),specularMapUv:Xe&&_(S.specularMap.channel),specularColorMapUv:Fe&&_(S.specularColorMap.channel),specularIntensityMapUv:st&&_(S.specularIntensityMap.channel),transmissionMapUv:I&&_(S.transmissionMap.channel),thicknessMapUv:oe&&_(S.thicknessMap.channel),alphaMapUv:$&&_(S.alphaMap.channel),vertexTangents:!!q.attributes.tangent&&(We||v),vertexColors:S.vertexColors,vertexAlphas:S.vertexColors===!0&&!!q.attributes.color&&q.attributes.color.itemSize===4,pointsUvs:F.isPoints===!0&&!!q.attributes.uv&&(pt||$),fog:!!X,useFog:S.fog===!0,fogExp2:!!X&&X.isFogExp2,flatShading:S.flatShading===!0,sizeAttenuation:S.sizeAttenuation===!0,logarithmicDepthBuffer:h,reverseDepthBuffer:Ee,skinning:F.isSkinnedMesh===!0,morphTargets:q.morphAttributes.position!==void 0,morphNormals:q.morphAttributes.normal!==void 0,morphColors:q.morphAttributes.color!==void 0,morphTargetsCount:ee,morphTextureStride:te,numDirLights:x.directional.length,numPointLights:x.point.length,numSpotLights:x.spot.length,numSpotLightMaps:x.spotLightMap.length,numRectAreaLights:x.rectArea.length,numHemiLights:x.hemi.length,numDirLightShadows:x.directionalShadowMap.length,numPointLightShadows:x.pointShadowMap.length,numSpotLightShadows:x.spotShadowMap.length,numSpotLightShadowsWithMaps:x.numSpotLightShadowsWithMaps,numLightProbes:x.numLightProbes,numClippingPlanes:a.numPlanes,numClipIntersection:a.numIntersection,dithering:S.dithering,shadowMapEnabled:n.shadowMap.enabled&&w.length>0,shadowMapType:n.shadowMap.type,toneMapping:ft,decodeVideoTexture:pt&&S.map.isVideoTexture===!0&&He.getTransfer(S.map.colorSpace)===nt,decodeVideoTextureEmissive:at&&S.emissiveMap.isVideoTexture===!0&&He.getTransfer(S.emissiveMap.colorSpace)===nt,premultipliedAlpha:S.premultipliedAlpha,doubleSided:S.side===mn,flipSided:S.side===Gt,useDepthPacking:S.depthPacking>=0,depthPacking:S.depthPacking||0,index0AttributeName:S.index0AttributeName,extensionClipCullDistance:Ne&&S.extensions.clipCullDistance===!0&&i.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(Ne&&S.extensions.multiDraw===!0||be)&&i.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:i.has("KHR_parallel_shader_compile"),customProgramCacheKey:S.customProgramCacheKey()};return bt.vertexUv1s=c.has(1),bt.vertexUv2s=c.has(2),bt.vertexUv3s=c.has(3),c.clear(),bt}function p(S){const x=[];if(S.shaderID?x.push(S.shaderID):(x.push(S.customVertexShaderID),x.push(S.customFragmentShaderID)),S.defines!==void 0)for(const w in S.defines)x.push(w),x.push(S.defines[w]);return S.isRawShaderMaterial===!1&&(T(x,S),E(x,S),x.push(n.outputColorSpace)),x.push(S.customProgramCacheKey),x.join()}function T(S,x){S.push(x.precision),S.push(x.outputColorSpace),S.push(x.envMapMode),S.push(x.envMapCubeUVHeight),S.push(x.mapUv),S.push(x.alphaMapUv),S.push(x.lightMapUv),S.push(x.aoMapUv),S.push(x.bumpMapUv),S.push(x.normalMapUv),S.push(x.displacementMapUv),S.push(x.emissiveMapUv),S.push(x.metalnessMapUv),S.push(x.roughnessMapUv),S.push(x.anisotropyMapUv),S.push(x.clearcoatMapUv),S.push(x.clearcoatNormalMapUv),S.push(x.clearcoatRoughnessMapUv),S.push(x.iridescenceMapUv),S.push(x.iridescenceThicknessMapUv),S.push(x.sheenColorMapUv),S.push(x.sheenRoughnessMapUv),S.push(x.specularMapUv),S.push(x.specularColorMapUv),S.push(x.specularIntensityMapUv),S.push(x.transmissionMapUv),S.push(x.thicknessMapUv),S.push(x.combine),S.push(x.fogExp2),S.push(x.sizeAttenuation),S.push(x.morphTargetsCount),S.push(x.morphAttributeCount),S.push(x.numDirLights),S.push(x.numPointLights),S.push(x.numSpotLights),S.push(x.numSpotLightMaps),S.push(x.numHemiLights),S.push(x.numRectAreaLights),S.push(x.numDirLightShadows),S.push(x.numPointLightShadows),S.push(x.numSpotLightShadows),S.push(x.numSpotLightShadowsWithMaps),S.push(x.numLightProbes),S.push(x.shadowMapType),S.push(x.toneMapping),S.push(x.numClippingPlanes),S.push(x.numClipIntersection),S.push(x.depthPacking)}function E(S,x){o.disableAll(),x.supportsVertexTextures&&o.enable(0),x.instancing&&o.enable(1),x.instancingColor&&o.enable(2),x.instancingMorph&&o.enable(3),x.matcap&&o.enable(4),x.envMap&&o.enable(5),x.normalMapObjectSpace&&o.enable(6),x.normalMapTangentSpace&&o.enable(7),x.clearcoat&&o.enable(8),x.iridescence&&o.enable(9),x.alphaTest&&o.enable(10),x.vertexColors&&o.enable(11),x.vertexAlphas&&o.enable(12),x.vertexUv1s&&o.enable(13),x.vertexUv2s&&o.enable(14),x.vertexUv3s&&o.enable(15),x.vertexTangents&&o.enable(16),x.anisotropy&&o.enable(17),x.alphaHash&&o.enable(18),x.batching&&o.enable(19),x.dispersion&&o.enable(20),x.batchingColor&&o.enable(21),S.push(o.mask),o.disableAll(),x.fog&&o.enable(0),x.useFog&&o.enable(1),x.flatShading&&o.enable(2),x.logarithmicDepthBuffer&&o.enable(3),x.reverseDepthBuffer&&o.enable(4),x.skinning&&o.enable(5),x.morphTargets&&o.enable(6),x.morphNormals&&o.enable(7),x.morphColors&&o.enable(8),x.premultipliedAlpha&&o.enable(9),x.shadowMapEnabled&&o.enable(10),x.doubleSided&&o.enable(11),x.flipSided&&o.enable(12),x.useDepthPacking&&o.enable(13),x.dithering&&o.enable(14),x.transmission&&o.enable(15),x.sheen&&o.enable(16),x.opaque&&o.enable(17),x.pointsUvs&&o.enable(18),x.decodeVideoTexture&&o.enable(19),x.decodeVideoTextureEmissive&&o.enable(20),x.alphaToCoverage&&o.enable(21),S.push(o.mask)}function M(S){const x=m[S.type];let w;if(x){const z=Tn[x];w=S_.clone(z.uniforms)}else w=S.uniforms;return w}function R(S,x){let w;for(let z=0,F=u.length;z<F;z++){const X=u[z];if(X.cacheKey===x){w=X,++w.usedTimes;break}}return w===void 0&&(w=new wM(n,x,S,s),u.push(w)),w}function P(S){if(--S.usedTimes===0){const x=u.indexOf(S);u[x]=u[u.length-1],u.pop(),S.destroy()}}function b(S){l.remove(S)}function C(){l.dispose()}return{getParameters:g,getProgramCacheKey:p,getUniforms:M,acquireProgram:R,releaseProgram:P,releaseShaderCache:b,programs:u,dispose:C}}function DM(){let n=new WeakMap;function e(a){return n.has(a)}function t(a){let o=n.get(a);return o===void 0&&(o={},n.set(a,o)),o}function i(a){n.delete(a)}function r(a,o,l){n.get(a)[o]=l}function s(){n=new WeakMap}return{has:e,get:t,remove:i,update:r,dispose:s}}function IM(n,e){return n.groupOrder!==e.groupOrder?n.groupOrder-e.groupOrder:n.renderOrder!==e.renderOrder?n.renderOrder-e.renderOrder:n.material.id!==e.material.id?n.material.id-e.material.id:n.z!==e.z?n.z-e.z:n.id-e.id}function qh(n,e){return n.groupOrder!==e.groupOrder?n.groupOrder-e.groupOrder:n.renderOrder!==e.renderOrder?n.renderOrder-e.renderOrder:n.z!==e.z?e.z-n.z:n.id-e.id}function Yh(){const n=[];let e=0;const t=[],i=[],r=[];function s(){e=0,t.length=0,i.length=0,r.length=0}function a(h,f,d,m,_,g){let p=n[e];return p===void 0?(p={id:h.id,object:h,geometry:f,material:d,groupOrder:m,renderOrder:h.renderOrder,z:_,group:g},n[e]=p):(p.id=h.id,p.object=h,p.geometry=f,p.material=d,p.groupOrder=m,p.renderOrder=h.renderOrder,p.z=_,p.group=g),e++,p}function o(h,f,d,m,_,g){const p=a(h,f,d,m,_,g);d.transmission>0?i.push(p):d.transparent===!0?r.push(p):t.push(p)}function l(h,f,d,m,_,g){const p=a(h,f,d,m,_,g);d.transmission>0?i.unshift(p):d.transparent===!0?r.unshift(p):t.unshift(p)}function c(h,f){t.length>1&&t.sort(h||IM),i.length>1&&i.sort(f||qh),r.length>1&&r.sort(f||qh)}function u(){for(let h=e,f=n.length;h<f;h++){const d=n[h];if(d.id===null)break;d.id=null,d.object=null,d.geometry=null,d.material=null,d.group=null}}return{opaque:t,transmissive:i,transparent:r,init:s,push:o,unshift:l,finish:u,sort:c}}function NM(){let n=new WeakMap;function e(i,r){const s=n.get(i);let a;return s===void 0?(a=new Yh,n.set(i,[a])):r>=s.length?(a=new Yh,s.push(a)):a=s[r],a}function t(){n=new WeakMap}return{get:e,dispose:t}}function UM(){const n={};return{get:function(e){if(n[e.id]!==void 0)return n[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new D,color:new Le};break;case"SpotLight":t={position:new D,direction:new D,color:new Le,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new D,color:new Le,distance:0,decay:0};break;case"HemisphereLight":t={direction:new D,skyColor:new Le,groundColor:new Le};break;case"RectAreaLight":t={color:new Le,position:new D,halfWidth:new D,halfHeight:new D};break}return n[e.id]=t,t}}}function FM(){const n={};return{get:function(e){if(n[e.id]!==void 0)return n[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Re};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Re};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Re,shadowCameraNear:1,shadowCameraFar:1e3};break}return n[e.id]=t,t}}}let OM=0;function BM(n,e){return(e.castShadow?2:0)-(n.castShadow?2:0)+(e.map?1:0)-(n.map?1:0)}function kM(n){const e=new UM,t=FM(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)i.probe.push(new D);const r=new D,s=new Ie,a=new Ie;function o(c){let u=0,h=0,f=0;for(let S=0;S<9;S++)i.probe[S].set(0,0,0);let d=0,m=0,_=0,g=0,p=0,T=0,E=0,M=0,R=0,P=0,b=0;c.sort(BM);for(let S=0,x=c.length;S<x;S++){const w=c[S],z=w.color,F=w.intensity,X=w.distance,q=w.shadow&&w.shadow.map?w.shadow.map.texture:null;if(w.isAmbientLight)u+=z.r*F,h+=z.g*F,f+=z.b*F;else if(w.isLightProbe){for(let G=0;G<9;G++)i.probe[G].addScaledVector(w.sh.coefficients[G],F);b++}else if(w.isDirectionalLight){const G=e.get(w);if(G.color.copy(w.color).multiplyScalar(w.intensity),w.castShadow){const j=w.shadow,H=t.get(w);H.shadowIntensity=j.intensity,H.shadowBias=j.bias,H.shadowNormalBias=j.normalBias,H.shadowRadius=j.radius,H.shadowMapSize=j.mapSize,i.directionalShadow[d]=H,i.directionalShadowMap[d]=q,i.directionalShadowMatrix[d]=w.shadow.matrix,T++}i.directional[d]=G,d++}else if(w.isSpotLight){const G=e.get(w);G.position.setFromMatrixPosition(w.matrixWorld),G.color.copy(z).multiplyScalar(F),G.distance=X,G.coneCos=Math.cos(w.angle),G.penumbraCos=Math.cos(w.angle*(1-w.penumbra)),G.decay=w.decay,i.spot[_]=G;const j=w.shadow;if(w.map&&(i.spotLightMap[R]=w.map,R++,j.updateMatrices(w),w.castShadow&&P++),i.spotLightMatrix[_]=j.matrix,w.castShadow){const H=t.get(w);H.shadowIntensity=j.intensity,H.shadowBias=j.bias,H.shadowNormalBias=j.normalBias,H.shadowRadius=j.radius,H.shadowMapSize=j.mapSize,i.spotShadow[_]=H,i.spotShadowMap[_]=q,M++}_++}else if(w.isRectAreaLight){const G=e.get(w);G.color.copy(z).multiplyScalar(F),G.halfWidth.set(w.width*.5,0,0),G.halfHeight.set(0,w.height*.5,0),i.rectArea[g]=G,g++}else if(w.isPointLight){const G=e.get(w);if(G.color.copy(w.color).multiplyScalar(w.intensity),G.distance=w.distance,G.decay=w.decay,w.castShadow){const j=w.shadow,H=t.get(w);H.shadowIntensity=j.intensity,H.shadowBias=j.bias,H.shadowNormalBias=j.normalBias,H.shadowRadius=j.radius,H.shadowMapSize=j.mapSize,H.shadowCameraNear=j.camera.near,H.shadowCameraFar=j.camera.far,i.pointShadow[m]=H,i.pointShadowMap[m]=q,i.pointShadowMatrix[m]=w.shadow.matrix,E++}i.point[m]=G,m++}else if(w.isHemisphereLight){const G=e.get(w);G.skyColor.copy(w.color).multiplyScalar(F),G.groundColor.copy(w.groundColor).multiplyScalar(F),i.hemi[p]=G,p++}}g>0&&(n.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=ae.LTC_FLOAT_1,i.rectAreaLTC2=ae.LTC_FLOAT_2):(i.rectAreaLTC1=ae.LTC_HALF_1,i.rectAreaLTC2=ae.LTC_HALF_2)),i.ambient[0]=u,i.ambient[1]=h,i.ambient[2]=f;const C=i.hash;(C.directionalLength!==d||C.pointLength!==m||C.spotLength!==_||C.rectAreaLength!==g||C.hemiLength!==p||C.numDirectionalShadows!==T||C.numPointShadows!==E||C.numSpotShadows!==M||C.numSpotMaps!==R||C.numLightProbes!==b)&&(i.directional.length=d,i.spot.length=_,i.rectArea.length=g,i.point.length=m,i.hemi.length=p,i.directionalShadow.length=T,i.directionalShadowMap.length=T,i.pointShadow.length=E,i.pointShadowMap.length=E,i.spotShadow.length=M,i.spotShadowMap.length=M,i.directionalShadowMatrix.length=T,i.pointShadowMatrix.length=E,i.spotLightMatrix.length=M+R-P,i.spotLightMap.length=R,i.numSpotLightShadowsWithMaps=P,i.numLightProbes=b,C.directionalLength=d,C.pointLength=m,C.spotLength=_,C.rectAreaLength=g,C.hemiLength=p,C.numDirectionalShadows=T,C.numPointShadows=E,C.numSpotShadows=M,C.numSpotMaps=R,C.numLightProbes=b,i.version=OM++)}function l(c,u){let h=0,f=0,d=0,m=0,_=0;const g=u.matrixWorldInverse;for(let p=0,T=c.length;p<T;p++){const E=c[p];if(E.isDirectionalLight){const M=i.directional[h];M.direction.setFromMatrixPosition(E.matrixWorld),r.setFromMatrixPosition(E.target.matrixWorld),M.direction.sub(r),M.direction.transformDirection(g),h++}else if(E.isSpotLight){const M=i.spot[d];M.position.setFromMatrixPosition(E.matrixWorld),M.position.applyMatrix4(g),M.direction.setFromMatrixPosition(E.matrixWorld),r.setFromMatrixPosition(E.target.matrixWorld),M.direction.sub(r),M.direction.transformDirection(g),d++}else if(E.isRectAreaLight){const M=i.rectArea[m];M.position.setFromMatrixPosition(E.matrixWorld),M.position.applyMatrix4(g),a.identity(),s.copy(E.matrixWorld),s.premultiply(g),a.extractRotation(s),M.halfWidth.set(E.width*.5,0,0),M.halfHeight.set(0,E.height*.5,0),M.halfWidth.applyMatrix4(a),M.halfHeight.applyMatrix4(a),m++}else if(E.isPointLight){const M=i.point[f];M.position.setFromMatrixPosition(E.matrixWorld),M.position.applyMatrix4(g),f++}else if(E.isHemisphereLight){const M=i.hemi[_];M.direction.setFromMatrixPosition(E.matrixWorld),M.direction.transformDirection(g),_++}}}return{setup:o,setupView:l,state:i}}function jh(n){const e=new kM(n),t=[],i=[];function r(u){c.camera=u,t.length=0,i.length=0}function s(u){t.push(u)}function a(u){i.push(u)}function o(){e.setup(t)}function l(u){e.setupView(t,u)}const c={lightsArray:t,shadowsArray:i,camera:null,lights:e,transmissionRenderTarget:{}};return{init:r,state:c,setupLights:o,setupLightsView:l,pushLight:s,pushShadow:a}}function zM(n){let e=new WeakMap;function t(r,s=0){const a=e.get(r);let o;return a===void 0?(o=new jh(n),e.set(r,[o])):s>=a.length?(o=new jh(n),a.push(o)):o=a[s],o}function i(){e=new WeakMap}return{get:t,dispose:i}}const HM=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function GM(n,e,t){let i=new Yc;const r=new Re,s=new Re,a=new Ke,o=new z_({depthPacking:Cg}),l=new H_,c={},u=t.maxTextureSize,h={[ti]:Gt,[Gt]:ti,[mn]:mn},f=new Ei({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Re},radius:{value:4}},vertexShader:HM,fragmentShader:VM}),d=f.clone();d.defines.HORIZONTAL_PASS=1;const m=new Sn;m.setAttribute("position",new Tt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new Kt(m,f),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=id;let p=this.type;this.render=function(P,b,C){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||P.length===0)return;const S=n.getRenderTarget(),x=n.getActiveCubeFace(),w=n.getActiveMipmapLevel(),z=n.state;z.setBlending(xi),z.buffers.color.setClear(1,1,1,1),z.buffers.depth.setTest(!0),z.setScissorTest(!1);const F=p!==qn&&this.type===qn,X=p===qn&&this.type!==qn;for(let q=0,G=P.length;q<G;q++){const j=P[q],H=j.shadow;if(H===void 0){console.warn("THREE.WebGLShadowMap:",j,"has no shadow.");continue}if(H.autoUpdate===!1&&H.needsUpdate===!1)continue;r.copy(H.mapSize);const ie=H.getFrameExtents();if(r.multiply(ie),s.copy(H.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/ie.x),r.x=s.x*ie.x,H.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/ie.y),r.y=s.y*ie.y,H.mapSize.y=s.y)),H.map===null||F===!0||X===!0){const ee=this.type!==qn?{minFilter:Ut,magFilter:Ut}:{};H.map!==null&&H.map.dispose(),H.map=new Wi(r.x,r.y,ee),H.map.texture.name=j.name+".shadowMap",H.camera.updateProjectionMatrix()}n.setRenderTarget(H.map),n.clear();const de=H.getViewportCount();for(let ee=0;ee<de;ee++){const te=H.getViewport(ee);a.set(s.x*te.x,s.y*te.y,s.x*te.z,s.y*te.w),z.viewport(a),H.updateMatrices(j,ee),i=H.getFrustum(),M(b,C,H.camera,j,this.type)}H.isPointLightShadow!==!0&&this.type===qn&&T(H,C),H.needsUpdate=!1}p=this.type,g.needsUpdate=!1,n.setRenderTarget(S,x,w)};function T(P,b){const C=e.update(_);f.defines.VSM_SAMPLES!==P.blurSamples&&(f.defines.VSM_SAMPLES=P.blurSamples,d.defines.VSM_SAMPLES=P.blurSamples,f.needsUpdate=!0,d.needsUpdate=!0),P.mapPass===null&&(P.mapPass=new Wi(r.x,r.y)),f.uniforms.shadow_pass.value=P.map.texture,f.uniforms.resolution.value=P.mapSize,f.uniforms.radius.value=P.radius,n.setRenderTarget(P.mapPass),n.clear(),n.renderBufferDirect(b,null,C,f,_,null),d.uniforms.shadow_pass.value=P.mapPass.texture,d.uniforms.resolution.value=P.mapSize,d.uniforms.radius.value=P.radius,n.setRenderTarget(P.map),n.clear(),n.renderBufferDirect(b,null,C,d,_,null)}function E(P,b,C,S){let x=null;const w=C.isPointLight===!0?P.customDistanceMaterial:P.customDepthMaterial;if(w!==void 0)x=w;else if(x=C.isPointLight===!0?l:o,n.localClippingEnabled&&b.clipShadows===!0&&Array.isArray(b.clippingPlanes)&&b.clippingPlanes.length!==0||b.displacementMap&&b.displacementScale!==0||b.alphaMap&&b.alphaTest>0||b.map&&b.alphaTest>0){const z=x.uuid,F=b.uuid;let X=c[z];X===void 0&&(X={},c[z]=X);let q=X[F];q===void 0&&(q=x.clone(),X[F]=q,b.addEventListener("dispose",R)),x=q}if(x.visible=b.visible,x.wireframe=b.wireframe,S===qn?x.side=b.shadowSide!==null?b.shadowSide:b.side:x.side=b.shadowSide!==null?b.shadowSide:h[b.side],x.alphaMap=b.alphaMap,x.alphaTest=b.alphaTest,x.map=b.map,x.clipShadows=b.clipShadows,x.clippingPlanes=b.clippingPlanes,x.clipIntersection=b.clipIntersection,x.displacementMap=b.displacementMap,x.displacementScale=b.displacementScale,x.displacementBias=b.displacementBias,x.wireframeLinewidth=b.wireframeLinewidth,x.linewidth=b.linewidth,C.isPointLight===!0&&x.isMeshDistanceMaterial===!0){const z=n.properties.get(x);z.light=C}return x}function M(P,b,C,S,x){if(P.visible===!1)return;if(P.layers.test(b.layers)&&(P.isMesh||P.isLine||P.isPoints)&&(P.castShadow||P.receiveShadow&&x===qn)&&(!P.frustumCulled||i.intersectsObject(P))){P.modelViewMatrix.multiplyMatrices(C.matrixWorldInverse,P.matrixWorld);const F=e.update(P),X=P.material;if(Array.isArray(X)){const q=F.groups;for(let G=0,j=q.length;G<j;G++){const H=q[G],ie=X[H.materialIndex];if(ie&&ie.visible){const de=E(P,ie,S,x);P.onBeforeShadow(n,P,b,C,F,de,H),n.renderBufferDirect(C,null,F,de,P,H),P.onAfterShadow(n,P,b,C,F,de,H)}}}else if(X.visible){const q=E(P,X,S,x);P.onBeforeShadow(n,P,b,C,F,q,null),n.renderBufferDirect(C,null,F,q,P,null),P.onAfterShadow(n,P,b,C,F,q,null)}}const z=P.children;for(let F=0,X=z.length;F<X;F++)M(z[F],b,C,S,x)}function R(P){P.target.removeEventListener("dispose",R);for(const C in c){const S=c[C],x=P.target.uuid;x in S&&(S[x].dispose(),delete S[x])}}}const WM={[Sl]:El,[Tl]:wl,[bl]:Rl,[wr]:Al,[El]:Sl,[wl]:Tl,[Rl]:bl,[Al]:wr};function XM(n,e){function t(){let I=!1;const oe=new Ke;let V=null;const $=new Ke(0,0,0,0);return{setMask:function(fe){V!==fe&&!I&&(n.colorMask(fe,fe,fe,fe),V=fe)},setLocked:function(fe){I=fe},setClear:function(fe,ue,Ne,ft,bt){bt===!0&&(fe*=ft,ue*=ft,Ne*=ft),oe.set(fe,ue,Ne,ft),$.equals(oe)===!1&&(n.clearColor(fe,ue,Ne,ft),$.copy(oe))},reset:function(){I=!1,V=null,$.set(-1,0,0,0)}}}function i(){let I=!1,oe=!1,V=null,$=null,fe=null;return{setReversed:function(ue){if(oe!==ue){const Ne=e.get("EXT_clip_control");oe?Ne.clipControlEXT(Ne.LOWER_LEFT_EXT,Ne.ZERO_TO_ONE_EXT):Ne.clipControlEXT(Ne.LOWER_LEFT_EXT,Ne.NEGATIVE_ONE_TO_ONE_EXT);const ft=fe;fe=null,this.setClear(ft)}oe=ue},getReversed:function(){return oe},setTest:function(ue){ue?re(n.DEPTH_TEST):Ee(n.DEPTH_TEST)},setMask:function(ue){V!==ue&&!I&&(n.depthMask(ue),V=ue)},setFunc:function(ue){if(oe&&(ue=WM[ue]),$!==ue){switch(ue){case Sl:n.depthFunc(n.NEVER);break;case El:n.depthFunc(n.ALWAYS);break;case Tl:n.depthFunc(n.LESS);break;case wr:n.depthFunc(n.LEQUAL);break;case bl:n.depthFunc(n.EQUAL);break;case Al:n.depthFunc(n.GEQUAL);break;case wl:n.depthFunc(n.GREATER);break;case Rl:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}$=ue}},setLocked:function(ue){I=ue},setClear:function(ue){fe!==ue&&(oe&&(ue=1-ue),n.clearDepth(ue),fe=ue)},reset:function(){I=!1,V=null,$=null,fe=null,oe=!1}}}function r(){let I=!1,oe=null,V=null,$=null,fe=null,ue=null,Ne=null,ft=null,bt=null;return{setTest:function(Je){I||(Je?re(n.STENCIL_TEST):Ee(n.STENCIL_TEST))},setMask:function(Je){oe!==Je&&!I&&(n.stencilMask(Je),oe=Je)},setFunc:function(Je,ln,Bn){(V!==Je||$!==ln||fe!==Bn)&&(n.stencilFunc(Je,ln,Bn),V=Je,$=ln,fe=Bn)},setOp:function(Je,ln,Bn){(ue!==Je||Ne!==ln||ft!==Bn)&&(n.stencilOp(Je,ln,Bn),ue=Je,Ne=ln,ft=Bn)},setLocked:function(Je){I=Je},setClear:function(Je){bt!==Je&&(n.clearStencil(Je),bt=Je)},reset:function(){I=!1,oe=null,V=null,$=null,fe=null,ue=null,Ne=null,ft=null,bt=null}}}const s=new t,a=new i,o=new r,l=new WeakMap,c=new WeakMap;let u={},h={},f=new WeakMap,d=[],m=null,_=!1,g=null,p=null,T=null,E=null,M=null,R=null,P=null,b=new Le(0,0,0),C=0,S=!1,x=null,w=null,z=null,F=null,X=null;const q=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let G=!1,j=0;const H=n.getParameter(n.VERSION);H.indexOf("WebGL")!==-1?(j=parseFloat(/^WebGL (\d)/.exec(H)[1]),G=j>=1):H.indexOf("OpenGL ES")!==-1&&(j=parseFloat(/^OpenGL ES (\d)/.exec(H)[1]),G=j>=2);let ie=null,de={};const ee=n.getParameter(n.SCISSOR_BOX),te=n.getParameter(n.VIEWPORT),we=new Ke().fromArray(ee),W=new Ke().fromArray(te);function J(I,oe,V,$){const fe=new Uint8Array(4),ue=n.createTexture();n.bindTexture(I,ue),n.texParameteri(I,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(I,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Ne=0;Ne<V;Ne++)I===n.TEXTURE_3D||I===n.TEXTURE_2D_ARRAY?n.texImage3D(oe,0,n.RGBA,1,1,$,0,n.RGBA,n.UNSIGNED_BYTE,fe):n.texImage2D(oe+Ne,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,fe);return ue}const he={};he[n.TEXTURE_2D]=J(n.TEXTURE_2D,n.TEXTURE_2D,1),he[n.TEXTURE_CUBE_MAP]=J(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),he[n.TEXTURE_2D_ARRAY]=J(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),he[n.TEXTURE_3D]=J(n.TEXTURE_3D,n.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),re(n.DEPTH_TEST),a.setFunc(wr),Ge(!1),We($m),re(n.CULL_FACE),L(xi);function re(I){u[I]!==!0&&(n.enable(I),u[I]=!0)}function Ee(I){u[I]!==!1&&(n.disable(I),u[I]=!1)}function ze(I,oe){return h[I]!==oe?(n.bindFramebuffer(I,oe),h[I]=oe,I===n.DRAW_FRAMEBUFFER&&(h[n.FRAMEBUFFER]=oe),I===n.FRAMEBUFFER&&(h[n.DRAW_FRAMEBUFFER]=oe),!0):!1}function be(I,oe){let V=d,$=!1;if(I){V=f.get(oe),V===void 0&&(V=[],f.set(oe,V));const fe=I.textures;if(V.length!==fe.length||V[0]!==n.COLOR_ATTACHMENT0){for(let ue=0,Ne=fe.length;ue<Ne;ue++)V[ue]=n.COLOR_ATTACHMENT0+ue;V.length=fe.length,$=!0}}else V[0]!==n.BACK&&(V[0]=n.BACK,$=!0);$&&n.drawBuffers(V)}function pt(I){return m!==I?(n.useProgram(I),m=I,!0):!1}const ht={[Ni]:n.FUNC_ADD,[Qm]:n.FUNC_SUBTRACT,[eg]:n.FUNC_REVERSE_SUBTRACT};ht[tg]=n.MIN,ht[ng]=n.MAX;const Ve={[ig]:n.ZERO,[rg]:n.ONE,[sg]:n.SRC_COLOR,[yl]:n.SRC_ALPHA,[hg]:n.SRC_ALPHA_SATURATE,[cg]:n.DST_COLOR,[og]:n.DST_ALPHA,[ag]:n.ONE_MINUS_SRC_COLOR,[Ml]:n.ONE_MINUS_SRC_ALPHA,[ug]:n.ONE_MINUS_DST_COLOR,[lg]:n.ONE_MINUS_DST_ALPHA,[fg]:n.CONSTANT_COLOR,[dg]:n.ONE_MINUS_CONSTANT_COLOR,[pg]:n.CONSTANT_ALPHA,[mg]:n.ONE_MINUS_CONSTANT_ALPHA};function L(I,oe,V,$,fe,ue,Ne,ft,bt,Je){if(I===xi){_===!0&&(Ee(n.BLEND),_=!1);return}if(_===!1&&(re(n.BLEND),_=!0),I!==Jm){if(I!==g||Je!==S){if((p!==Ni||M!==Ni)&&(n.blendEquation(n.FUNC_ADD),p=Ni,M=Ni),Je)switch(I){case Sr:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Du:n.blendFunc(n.ONE,n.ONE);break;case Iu:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Nu:n.blendFuncSeparate(n.ZERO,n.SRC_COLOR,n.ZERO,n.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",I);break}else switch(I){case Sr:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Du:n.blendFunc(n.SRC_ALPHA,n.ONE);break;case Iu:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Nu:n.blendFunc(n.ZERO,n.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",I);break}T=null,E=null,R=null,P=null,b.set(0,0,0),C=0,g=I,S=Je}return}fe=fe||oe,ue=ue||V,Ne=Ne||$,(oe!==p||fe!==M)&&(n.blendEquationSeparate(ht[oe],ht[fe]),p=oe,M=fe),(V!==T||$!==E||ue!==R||Ne!==P)&&(n.blendFuncSeparate(Ve[V],Ve[$],Ve[ue],Ve[Ne]),T=V,E=$,R=ue,P=Ne),(ft.equals(b)===!1||bt!==C)&&(n.blendColor(ft.r,ft.g,ft.b,bt),b.copy(ft),C=bt),g=I,S=!1}function Zt(I,oe){I.side===mn?Ee(n.CULL_FACE):re(n.CULL_FACE);let V=I.side===Gt;oe&&(V=!V),Ge(V),I.blending===Sr&&I.transparent===!1?L(xi):L(I.blending,I.blendEquation,I.blendSrc,I.blendDst,I.blendEquationAlpha,I.blendSrcAlpha,I.blendDstAlpha,I.blendColor,I.blendAlpha,I.premultipliedAlpha),a.setFunc(I.depthFunc),a.setTest(I.depthTest),a.setMask(I.depthWrite),s.setMask(I.colorWrite);const $=I.stencilWrite;o.setTest($),$&&(o.setMask(I.stencilWriteMask),o.setFunc(I.stencilFunc,I.stencilRef,I.stencilFuncMask),o.setOp(I.stencilFail,I.stencilZFail,I.stencilZPass)),at(I.polygonOffset,I.polygonOffsetFactor,I.polygonOffsetUnits),I.alphaToCoverage===!0?re(n.SAMPLE_ALPHA_TO_COVERAGE):Ee(n.SAMPLE_ALPHA_TO_COVERAGE)}function Ge(I){x!==I&&(I?n.frontFace(n.CW):n.frontFace(n.CCW),x=I)}function We(I){re(n.CULL_FACE),I!==w&&n.cullFace(n.BACK),w=I}function Me(I){I!==z&&(G&&n.lineWidth(I),z=I)}function at(I,oe,V){I?(re(n.POLYGON_OFFSET_FILL),(F!==oe||X!==V)&&(n.polygonOffset(oe,V),F=oe,X=V)):Ee(n.POLYGON_OFFSET_FILL)}function ye(I){I?re(n.SCISSOR_TEST):Ee(n.SCISSOR_TEST)}function A(I){I===void 0&&(I=n.TEXTURE0+q-1),ie!==I&&(n.activeTexture(I),ie=I)}function v(I,oe,V){V===void 0&&(ie===null?V=n.TEXTURE0+q-1:V=ie);let $=de[V];$===void 0&&($={type:void 0,texture:void 0},de[V]=$),($.type!==I||$.texture!==oe)&&(ie!==V&&(n.activeTexture(V),ie=V),n.bindTexture(I,oe||he[I]),$.type=I,$.texture=oe)}function O(){const I=de[ie];I!==void 0&&I.type!==void 0&&(n.bindTexture(I.type,null),I.type=void 0,I.texture=void 0)}function K(){try{n.compressedTexImage2D.apply(n,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function Z(){try{n.compressedTexImage3D.apply(n,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function Y(){try{n.texSubImage2D.apply(n,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function xe(){try{n.texSubImage3D.apply(n,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function ce(){try{n.compressedTexSubImage2D.apply(n,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function me(){try{n.compressedTexSubImage3D.apply(n,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function qe(){try{n.texStorage2D.apply(n,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function ne(){try{n.texStorage3D.apply(n,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function ge(){try{n.texImage2D.apply(n,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function Ae(){try{n.texImage3D.apply(n,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function Ce(I){we.equals(I)===!1&&(n.scissor(I.x,I.y,I.z,I.w),we.copy(I))}function _e(I){W.equals(I)===!1&&(n.viewport(I.x,I.y,I.z,I.w),W.copy(I))}function Xe(I,oe){let V=c.get(oe);V===void 0&&(V=new WeakMap,c.set(oe,V));let $=V.get(I);$===void 0&&($=n.getUniformBlockIndex(oe,I.name),V.set(I,$))}function Fe(I,oe){const $=c.get(oe).get(I);l.get(oe)!==$&&(n.uniformBlockBinding(oe,$,I.__bindingPointIndex),l.set(oe,$))}function st(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),a.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),u={},ie=null,de={},h={},f=new WeakMap,d=[],m=null,_=!1,g=null,p=null,T=null,E=null,M=null,R=null,P=null,b=new Le(0,0,0),C=0,S=!1,x=null,w=null,z=null,F=null,X=null,we.set(0,0,n.canvas.width,n.canvas.height),W.set(0,0,n.canvas.width,n.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:re,disable:Ee,bindFramebuffer:ze,drawBuffers:be,useProgram:pt,setBlending:L,setMaterial:Zt,setFlipSided:Ge,setCullFace:We,setLineWidth:Me,setPolygonOffset:at,setScissorTest:ye,activeTexture:A,bindTexture:v,unbindTexture:O,compressedTexImage2D:K,compressedTexImage3D:Z,texImage2D:ge,texImage3D:Ae,updateUBOMapping:Xe,uniformBlockBinding:Fe,texStorage2D:qe,texStorage3D:ne,texSubImage2D:Y,texSubImage3D:xe,compressedTexSubImage2D:ce,compressedTexSubImage3D:me,scissor:Ce,viewport:_e,reset:st}}function qM(n,e,t,i,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Re,u=new WeakMap;let h;const f=new WeakMap;let d=!1;try{d=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function m(A,v){return d?new OffscreenCanvas(A,v):Es("canvas")}function _(A,v,O){let K=1;const Z=ye(A);if((Z.width>O||Z.height>O)&&(K=O/Math.max(Z.width,Z.height)),K<1)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap||typeof VideoFrame<"u"&&A instanceof VideoFrame){const Y=Math.floor(K*Z.width),xe=Math.floor(K*Z.height);h===void 0&&(h=m(Y,xe));const ce=v?m(Y,xe):h;return ce.width=Y,ce.height=xe,ce.getContext("2d").drawImage(A,0,0,Y,xe),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+Z.width+"x"+Z.height+") to ("+Y+"x"+xe+")."),ce}else return"data"in A&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+Z.width+"x"+Z.height+")."),A;return A}function g(A){return A.generateMipmaps}function p(A){n.generateMipmap(A)}function T(A){return A.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:A.isWebGL3DRenderTarget?n.TEXTURE_3D:A.isWebGLArrayRenderTarget||A.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function E(A,v,O,K,Z=!1){if(A!==null){if(n[A]!==void 0)return n[A];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let Y=v;if(v===n.RED&&(O===n.FLOAT&&(Y=n.R32F),O===n.HALF_FLOAT&&(Y=n.R16F),O===n.UNSIGNED_BYTE&&(Y=n.R8)),v===n.RED_INTEGER&&(O===n.UNSIGNED_BYTE&&(Y=n.R8UI),O===n.UNSIGNED_SHORT&&(Y=n.R16UI),O===n.UNSIGNED_INT&&(Y=n.R32UI),O===n.BYTE&&(Y=n.R8I),O===n.SHORT&&(Y=n.R16I),O===n.INT&&(Y=n.R32I)),v===n.RG&&(O===n.FLOAT&&(Y=n.RG32F),O===n.HALF_FLOAT&&(Y=n.RG16F),O===n.UNSIGNED_BYTE&&(Y=n.RG8)),v===n.RG_INTEGER&&(O===n.UNSIGNED_BYTE&&(Y=n.RG8UI),O===n.UNSIGNED_SHORT&&(Y=n.RG16UI),O===n.UNSIGNED_INT&&(Y=n.RG32UI),O===n.BYTE&&(Y=n.RG8I),O===n.SHORT&&(Y=n.RG16I),O===n.INT&&(Y=n.RG32I)),v===n.RGB_INTEGER&&(O===n.UNSIGNED_BYTE&&(Y=n.RGB8UI),O===n.UNSIGNED_SHORT&&(Y=n.RGB16UI),O===n.UNSIGNED_INT&&(Y=n.RGB32UI),O===n.BYTE&&(Y=n.RGB8I),O===n.SHORT&&(Y=n.RGB16I),O===n.INT&&(Y=n.RGB32I)),v===n.RGBA_INTEGER&&(O===n.UNSIGNED_BYTE&&(Y=n.RGBA8UI),O===n.UNSIGNED_SHORT&&(Y=n.RGBA16UI),O===n.UNSIGNED_INT&&(Y=n.RGBA32UI),O===n.BYTE&&(Y=n.RGBA8I),O===n.SHORT&&(Y=n.RGBA16I),O===n.INT&&(Y=n.RGBA32I)),v===n.RGB&&O===n.UNSIGNED_INT_5_9_9_9_REV&&(Y=n.RGB9_E5),v===n.RGBA){const xe=Z?za:He.getTransfer(K);O===n.FLOAT&&(Y=n.RGBA32F),O===n.HALF_FLOAT&&(Y=n.RGBA16F),O===n.UNSIGNED_BYTE&&(Y=xe===nt?n.SRGB8_ALPHA8:n.RGBA8),O===n.UNSIGNED_SHORT_4_4_4_4&&(Y=n.RGBA4),O===n.UNSIGNED_SHORT_5_5_5_1&&(Y=n.RGB5_A1)}return(Y===n.R16F||Y===n.R32F||Y===n.RG16F||Y===n.RG32F||Y===n.RGBA16F||Y===n.RGBA32F)&&e.get("EXT_color_buffer_float"),Y}function M(A,v){let O;return A?v===null||v===Gi||v===Lr?O=n.DEPTH24_STENCIL8:v===xn?O=n.DEPTH32F_STENCIL8:v===ys&&(O=n.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):v===null||v===Gi||v===Lr?O=n.DEPTH_COMPONENT24:v===xn?O=n.DEPTH_COMPONENT32F:v===ys&&(O=n.DEPTH_COMPONENT16),O}function R(A,v){return g(A)===!0||A.isFramebufferTexture&&A.minFilter!==Ut&&A.minFilter!==jt?Math.log2(Math.max(v.width,v.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?v.mipmaps.length:1}function P(A){const v=A.target;v.removeEventListener("dispose",P),C(v),v.isVideoTexture&&u.delete(v)}function b(A){const v=A.target;v.removeEventListener("dispose",b),x(v)}function C(A){const v=i.get(A);if(v.__webglInit===void 0)return;const O=A.source,K=f.get(O);if(K){const Z=K[v.__cacheKey];Z.usedTimes--,Z.usedTimes===0&&S(A),Object.keys(K).length===0&&f.delete(O)}i.remove(A)}function S(A){const v=i.get(A);n.deleteTexture(v.__webglTexture);const O=A.source,K=f.get(O);delete K[v.__cacheKey],a.memory.textures--}function x(A){const v=i.get(A);if(A.depthTexture&&(A.depthTexture.dispose(),i.remove(A.depthTexture)),A.isWebGLCubeRenderTarget)for(let K=0;K<6;K++){if(Array.isArray(v.__webglFramebuffer[K]))for(let Z=0;Z<v.__webglFramebuffer[K].length;Z++)n.deleteFramebuffer(v.__webglFramebuffer[K][Z]);else n.deleteFramebuffer(v.__webglFramebuffer[K]);v.__webglDepthbuffer&&n.deleteRenderbuffer(v.__webglDepthbuffer[K])}else{if(Array.isArray(v.__webglFramebuffer))for(let K=0;K<v.__webglFramebuffer.length;K++)n.deleteFramebuffer(v.__webglFramebuffer[K]);else n.deleteFramebuffer(v.__webglFramebuffer);if(v.__webglDepthbuffer&&n.deleteRenderbuffer(v.__webglDepthbuffer),v.__webglMultisampledFramebuffer&&n.deleteFramebuffer(v.__webglMultisampledFramebuffer),v.__webglColorRenderbuffer)for(let K=0;K<v.__webglColorRenderbuffer.length;K++)v.__webglColorRenderbuffer[K]&&n.deleteRenderbuffer(v.__webglColorRenderbuffer[K]);v.__webglDepthRenderbuffer&&n.deleteRenderbuffer(v.__webglDepthRenderbuffer)}const O=A.textures;for(let K=0,Z=O.length;K<Z;K++){const Y=i.get(O[K]);Y.__webglTexture&&(n.deleteTexture(Y.__webglTexture),a.memory.textures--),i.remove(O[K])}i.remove(A)}let w=0;function z(){w=0}function F(){const A=w;return A>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+A+" texture units while this GPU supports only "+r.maxTextures),w+=1,A}function X(A){const v=[];return v.push(A.wrapS),v.push(A.wrapT),v.push(A.wrapR||0),v.push(A.magFilter),v.push(A.minFilter),v.push(A.anisotropy),v.push(A.internalFormat),v.push(A.format),v.push(A.type),v.push(A.generateMipmaps),v.push(A.premultiplyAlpha),v.push(A.flipY),v.push(A.unpackAlignment),v.push(A.colorSpace),v.join()}function q(A,v){const O=i.get(A);if(A.isVideoTexture&&Me(A),A.isRenderTargetTexture===!1&&A.version>0&&O.__version!==A.version){const K=A.image;if(K===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(K.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{W(O,A,v);return}}t.bindTexture(n.TEXTURE_2D,O.__webglTexture,n.TEXTURE0+v)}function G(A,v){const O=i.get(A);if(A.version>0&&O.__version!==A.version){W(O,A,v);return}t.bindTexture(n.TEXTURE_2D_ARRAY,O.__webglTexture,n.TEXTURE0+v)}function j(A,v){const O=i.get(A);if(A.version>0&&O.__version!==A.version){W(O,A,v);return}t.bindTexture(n.TEXTURE_3D,O.__webglTexture,n.TEXTURE0+v)}function H(A,v){const O=i.get(A);if(A.version>0&&O.__version!==A.version){J(O,A,v);return}t.bindTexture(n.TEXTURE_CUBE_MAP,O.__webglTexture,n.TEXTURE0+v)}const ie={[Pr]:n.REPEAT,[mi]:n.CLAMP_TO_EDGE,[ka]:n.MIRRORED_REPEAT},de={[Ut]:n.NEAREST,[ad]:n.NEAREST_MIPMAP_NEAREST,[ls]:n.NEAREST_MIPMAP_LINEAR,[jt]:n.LINEAR,[ya]:n.LINEAR_MIPMAP_NEAREST,[Kn]:n.LINEAR_MIPMAP_LINEAR},ee={[Lg]:n.NEVER,[Og]:n.ALWAYS,[Dg]:n.LESS,[vd]:n.LEQUAL,[Ig]:n.EQUAL,[Fg]:n.GEQUAL,[Ng]:n.GREATER,[Ug]:n.NOTEQUAL};function te(A,v){if(v.type===xn&&e.has("OES_texture_float_linear")===!1&&(v.magFilter===jt||v.magFilter===ya||v.magFilter===ls||v.magFilter===Kn||v.minFilter===jt||v.minFilter===ya||v.minFilter===ls||v.minFilter===Kn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(A,n.TEXTURE_WRAP_S,ie[v.wrapS]),n.texParameteri(A,n.TEXTURE_WRAP_T,ie[v.wrapT]),(A===n.TEXTURE_3D||A===n.TEXTURE_2D_ARRAY)&&n.texParameteri(A,n.TEXTURE_WRAP_R,ie[v.wrapR]),n.texParameteri(A,n.TEXTURE_MAG_FILTER,de[v.magFilter]),n.texParameteri(A,n.TEXTURE_MIN_FILTER,de[v.minFilter]),v.compareFunction&&(n.texParameteri(A,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(A,n.TEXTURE_COMPARE_FUNC,ee[v.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(v.magFilter===Ut||v.minFilter!==ls&&v.minFilter!==Kn||v.type===xn&&e.has("OES_texture_float_linear")===!1)return;if(v.anisotropy>1||i.get(v).__currentAnisotropy){const O=e.get("EXT_texture_filter_anisotropic");n.texParameterf(A,O.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,r.getMaxAnisotropy())),i.get(v).__currentAnisotropy=v.anisotropy}}}function we(A,v){let O=!1;A.__webglInit===void 0&&(A.__webglInit=!0,v.addEventListener("dispose",P));const K=v.source;let Z=f.get(K);Z===void 0&&(Z={},f.set(K,Z));const Y=X(v);if(Y!==A.__cacheKey){Z[Y]===void 0&&(Z[Y]={texture:n.createTexture(),usedTimes:0},a.memory.textures++,O=!0),Z[Y].usedTimes++;const xe=Z[A.__cacheKey];xe!==void 0&&(Z[A.__cacheKey].usedTimes--,xe.usedTimes===0&&S(v)),A.__cacheKey=Y,A.__webglTexture=Z[Y].texture}return O}function W(A,v,O){let K=n.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&(K=n.TEXTURE_2D_ARRAY),v.isData3DTexture&&(K=n.TEXTURE_3D);const Z=we(A,v),Y=v.source;t.bindTexture(K,A.__webglTexture,n.TEXTURE0+O);const xe=i.get(Y);if(Y.version!==xe.__version||Z===!0){t.activeTexture(n.TEXTURE0+O);const ce=He.getPrimaries(He.workingColorSpace),me=v.colorSpace===pi?null:He.getPrimaries(v.colorSpace),qe=v.colorSpace===pi||ce===me?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,v.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,v.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,qe);let ne=_(v.image,!1,r.maxTextureSize);ne=at(v,ne);const ge=s.convert(v.format,v.colorSpace),Ae=s.convert(v.type);let Ce=E(v.internalFormat,ge,Ae,v.colorSpace,v.isVideoTexture);te(K,v);let _e;const Xe=v.mipmaps,Fe=v.isVideoTexture!==!0,st=xe.__version===void 0||Z===!0,I=Y.dataReady,oe=R(v,ne);if(v.isDepthTexture)Ce=M(v.format===Dr,v.type),st&&(Fe?t.texStorage2D(n.TEXTURE_2D,1,Ce,ne.width,ne.height):t.texImage2D(n.TEXTURE_2D,0,Ce,ne.width,ne.height,0,ge,Ae,null));else if(v.isDataTexture)if(Xe.length>0){Fe&&st&&t.texStorage2D(n.TEXTURE_2D,oe,Ce,Xe[0].width,Xe[0].height);for(let V=0,$=Xe.length;V<$;V++)_e=Xe[V],Fe?I&&t.texSubImage2D(n.TEXTURE_2D,V,0,0,_e.width,_e.height,ge,Ae,_e.data):t.texImage2D(n.TEXTURE_2D,V,Ce,_e.width,_e.height,0,ge,Ae,_e.data);v.generateMipmaps=!1}else Fe?(st&&t.texStorage2D(n.TEXTURE_2D,oe,Ce,ne.width,ne.height),I&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,ne.width,ne.height,ge,Ae,ne.data)):t.texImage2D(n.TEXTURE_2D,0,Ce,ne.width,ne.height,0,ge,Ae,ne.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){Fe&&st&&t.texStorage3D(n.TEXTURE_2D_ARRAY,oe,Ce,Xe[0].width,Xe[0].height,ne.depth);for(let V=0,$=Xe.length;V<$;V++)if(_e=Xe[V],v.format!==sn)if(ge!==null)if(Fe){if(I)if(v.layerUpdates.size>0){const fe=Th(_e.width,_e.height,v.format,v.type);for(const ue of v.layerUpdates){const Ne=_e.data.subarray(ue*fe/_e.data.BYTES_PER_ELEMENT,(ue+1)*fe/_e.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,V,0,0,ue,_e.width,_e.height,1,ge,Ne)}v.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,V,0,0,0,_e.width,_e.height,ne.depth,ge,_e.data)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,V,Ce,_e.width,_e.height,ne.depth,0,_e.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Fe?I&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,V,0,0,0,_e.width,_e.height,ne.depth,ge,Ae,_e.data):t.texImage3D(n.TEXTURE_2D_ARRAY,V,Ce,_e.width,_e.height,ne.depth,0,ge,Ae,_e.data)}else{Fe&&st&&t.texStorage2D(n.TEXTURE_2D,oe,Ce,Xe[0].width,Xe[0].height);for(let V=0,$=Xe.length;V<$;V++)_e=Xe[V],v.format!==sn?ge!==null?Fe?I&&t.compressedTexSubImage2D(n.TEXTURE_2D,V,0,0,_e.width,_e.height,ge,_e.data):t.compressedTexImage2D(n.TEXTURE_2D,V,Ce,_e.width,_e.height,0,_e.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Fe?I&&t.texSubImage2D(n.TEXTURE_2D,V,0,0,_e.width,_e.height,ge,Ae,_e.data):t.texImage2D(n.TEXTURE_2D,V,Ce,_e.width,_e.height,0,ge,Ae,_e.data)}else if(v.isDataArrayTexture)if(Fe){if(st&&t.texStorage3D(n.TEXTURE_2D_ARRAY,oe,Ce,ne.width,ne.height,ne.depth),I)if(v.layerUpdates.size>0){const V=Th(ne.width,ne.height,v.format,v.type);for(const $ of v.layerUpdates){const fe=ne.data.subarray($*V/ne.data.BYTES_PER_ELEMENT,($+1)*V/ne.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,$,ne.width,ne.height,1,ge,Ae,fe)}v.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,ne.width,ne.height,ne.depth,ge,Ae,ne.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,Ce,ne.width,ne.height,ne.depth,0,ge,Ae,ne.data);else if(v.isData3DTexture)Fe?(st&&t.texStorage3D(n.TEXTURE_3D,oe,Ce,ne.width,ne.height,ne.depth),I&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,ne.width,ne.height,ne.depth,ge,Ae,ne.data)):t.texImage3D(n.TEXTURE_3D,0,Ce,ne.width,ne.height,ne.depth,0,ge,Ae,ne.data);else if(v.isFramebufferTexture){if(st)if(Fe)t.texStorage2D(n.TEXTURE_2D,oe,Ce,ne.width,ne.height);else{let V=ne.width,$=ne.height;for(let fe=0;fe<oe;fe++)t.texImage2D(n.TEXTURE_2D,fe,Ce,V,$,0,ge,Ae,null),V>>=1,$>>=1}}else if(Xe.length>0){if(Fe&&st){const V=ye(Xe[0]);t.texStorage2D(n.TEXTURE_2D,oe,Ce,V.width,V.height)}for(let V=0,$=Xe.length;V<$;V++)_e=Xe[V],Fe?I&&t.texSubImage2D(n.TEXTURE_2D,V,0,0,ge,Ae,_e):t.texImage2D(n.TEXTURE_2D,V,Ce,ge,Ae,_e);v.generateMipmaps=!1}else if(Fe){if(st){const V=ye(ne);t.texStorage2D(n.TEXTURE_2D,oe,Ce,V.width,V.height)}I&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,ge,Ae,ne)}else t.texImage2D(n.TEXTURE_2D,0,Ce,ge,Ae,ne);g(v)&&p(K),xe.__version=Y.version,v.onUpdate&&v.onUpdate(v)}A.__version=v.version}function J(A,v,O){if(v.image.length!==6)return;const K=we(A,v),Z=v.source;t.bindTexture(n.TEXTURE_CUBE_MAP,A.__webglTexture,n.TEXTURE0+O);const Y=i.get(Z);if(Z.version!==Y.__version||K===!0){t.activeTexture(n.TEXTURE0+O);const xe=He.getPrimaries(He.workingColorSpace),ce=v.colorSpace===pi?null:He.getPrimaries(v.colorSpace),me=v.colorSpace===pi||xe===ce?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,v.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,v.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,me);const qe=v.isCompressedTexture||v.image[0].isCompressedTexture,ne=v.image[0]&&v.image[0].isDataTexture,ge=[];for(let $=0;$<6;$++)!qe&&!ne?ge[$]=_(v.image[$],!0,r.maxCubemapSize):ge[$]=ne?v.image[$].image:v.image[$],ge[$]=at(v,ge[$]);const Ae=ge[0],Ce=s.convert(v.format,v.colorSpace),_e=s.convert(v.type),Xe=E(v.internalFormat,Ce,_e,v.colorSpace),Fe=v.isVideoTexture!==!0,st=Y.__version===void 0||K===!0,I=Z.dataReady;let oe=R(v,Ae);te(n.TEXTURE_CUBE_MAP,v);let V;if(qe){Fe&&st&&t.texStorage2D(n.TEXTURE_CUBE_MAP,oe,Xe,Ae.width,Ae.height);for(let $=0;$<6;$++){V=ge[$].mipmaps;for(let fe=0;fe<V.length;fe++){const ue=V[fe];v.format!==sn?Ce!==null?Fe?I&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+$,fe,0,0,ue.width,ue.height,Ce,ue.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+$,fe,Xe,ue.width,ue.height,0,ue.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Fe?I&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+$,fe,0,0,ue.width,ue.height,Ce,_e,ue.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+$,fe,Xe,ue.width,ue.height,0,Ce,_e,ue.data)}}}else{if(V=v.mipmaps,Fe&&st){V.length>0&&oe++;const $=ye(ge[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,oe,Xe,$.width,$.height)}for(let $=0;$<6;$++)if(ne){Fe?I&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,0,0,ge[$].width,ge[$].height,Ce,_e,ge[$].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,Xe,ge[$].width,ge[$].height,0,Ce,_e,ge[$].data);for(let fe=0;fe<V.length;fe++){const Ne=V[fe].image[$].image;Fe?I&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+$,fe+1,0,0,Ne.width,Ne.height,Ce,_e,Ne.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+$,fe+1,Xe,Ne.width,Ne.height,0,Ce,_e,Ne.data)}}else{Fe?I&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,0,0,Ce,_e,ge[$]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,Xe,Ce,_e,ge[$]);for(let fe=0;fe<V.length;fe++){const ue=V[fe];Fe?I&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+$,fe+1,0,0,Ce,_e,ue.image[$]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+$,fe+1,Xe,Ce,_e,ue.image[$])}}}g(v)&&p(n.TEXTURE_CUBE_MAP),Y.__version=Z.version,v.onUpdate&&v.onUpdate(v)}A.__version=v.version}function he(A,v,O,K,Z,Y){const xe=s.convert(O.format,O.colorSpace),ce=s.convert(O.type),me=E(O.internalFormat,xe,ce,O.colorSpace),qe=i.get(v),ne=i.get(O);if(ne.__renderTarget=v,!qe.__hasExternalTextures){const ge=Math.max(1,v.width>>Y),Ae=Math.max(1,v.height>>Y);Z===n.TEXTURE_3D||Z===n.TEXTURE_2D_ARRAY?t.texImage3D(Z,Y,me,ge,Ae,v.depth,0,xe,ce,null):t.texImage2D(Z,Y,me,ge,Ae,0,xe,ce,null)}t.bindFramebuffer(n.FRAMEBUFFER,A),We(v)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,K,Z,ne.__webglTexture,0,Ge(v)):(Z===n.TEXTURE_2D||Z>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&Z<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,K,Z,ne.__webglTexture,Y),t.bindFramebuffer(n.FRAMEBUFFER,null)}function re(A,v,O){if(n.bindRenderbuffer(n.RENDERBUFFER,A),v.depthBuffer){const K=v.depthTexture,Z=K&&K.isDepthTexture?K.type:null,Y=M(v.stencilBuffer,Z),xe=v.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ce=Ge(v);We(v)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,ce,Y,v.width,v.height):O?n.renderbufferStorageMultisample(n.RENDERBUFFER,ce,Y,v.width,v.height):n.renderbufferStorage(n.RENDERBUFFER,Y,v.width,v.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,xe,n.RENDERBUFFER,A)}else{const K=v.textures;for(let Z=0;Z<K.length;Z++){const Y=K[Z],xe=s.convert(Y.format,Y.colorSpace),ce=s.convert(Y.type),me=E(Y.internalFormat,xe,ce,Y.colorSpace),qe=Ge(v);O&&We(v)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,qe,me,v.width,v.height):We(v)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,qe,me,v.width,v.height):n.renderbufferStorage(n.RENDERBUFFER,me,v.width,v.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function Ee(A,v){if(v&&v.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(n.FRAMEBUFFER,A),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const K=i.get(v.depthTexture);K.__renderTarget=v,(!K.__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),q(v.depthTexture,0);const Z=K.__webglTexture,Y=Ge(v);if(v.depthTexture.format===Er)We(v)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,Z,0,Y):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,Z,0);else if(v.depthTexture.format===Dr)We(v)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,Z,0,Y):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,Z,0);else throw new Error("Unknown depthTexture format")}function ze(A){const v=i.get(A),O=A.isWebGLCubeRenderTarget===!0;if(v.__boundDepthTexture!==A.depthTexture){const K=A.depthTexture;if(v.__depthDisposeCallback&&v.__depthDisposeCallback(),K){const Z=()=>{delete v.__boundDepthTexture,delete v.__depthDisposeCallback,K.removeEventListener("dispose",Z)};K.addEventListener("dispose",Z),v.__depthDisposeCallback=Z}v.__boundDepthTexture=K}if(A.depthTexture&&!v.__autoAllocateDepthBuffer){if(O)throw new Error("target.depthTexture not supported in Cube render targets");Ee(v.__webglFramebuffer,A)}else if(O){v.__webglDepthbuffer=[];for(let K=0;K<6;K++)if(t.bindFramebuffer(n.FRAMEBUFFER,v.__webglFramebuffer[K]),v.__webglDepthbuffer[K]===void 0)v.__webglDepthbuffer[K]=n.createRenderbuffer(),re(v.__webglDepthbuffer[K],A,!1);else{const Z=A.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,Y=v.__webglDepthbuffer[K];n.bindRenderbuffer(n.RENDERBUFFER,Y),n.framebufferRenderbuffer(n.FRAMEBUFFER,Z,n.RENDERBUFFER,Y)}}else if(t.bindFramebuffer(n.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer===void 0)v.__webglDepthbuffer=n.createRenderbuffer(),re(v.__webglDepthbuffer,A,!1);else{const K=A.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,Z=v.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,Z),n.framebufferRenderbuffer(n.FRAMEBUFFER,K,n.RENDERBUFFER,Z)}t.bindFramebuffer(n.FRAMEBUFFER,null)}function be(A,v,O){const K=i.get(A);v!==void 0&&he(K.__webglFramebuffer,A,A.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),O!==void 0&&ze(A)}function pt(A){const v=A.texture,O=i.get(A),K=i.get(v);A.addEventListener("dispose",b);const Z=A.textures,Y=A.isWebGLCubeRenderTarget===!0,xe=Z.length>1;if(xe||(K.__webglTexture===void 0&&(K.__webglTexture=n.createTexture()),K.__version=v.version,a.memory.textures++),Y){O.__webglFramebuffer=[];for(let ce=0;ce<6;ce++)if(v.mipmaps&&v.mipmaps.length>0){O.__webglFramebuffer[ce]=[];for(let me=0;me<v.mipmaps.length;me++)O.__webglFramebuffer[ce][me]=n.createFramebuffer()}else O.__webglFramebuffer[ce]=n.createFramebuffer()}else{if(v.mipmaps&&v.mipmaps.length>0){O.__webglFramebuffer=[];for(let ce=0;ce<v.mipmaps.length;ce++)O.__webglFramebuffer[ce]=n.createFramebuffer()}else O.__webglFramebuffer=n.createFramebuffer();if(xe)for(let ce=0,me=Z.length;ce<me;ce++){const qe=i.get(Z[ce]);qe.__webglTexture===void 0&&(qe.__webglTexture=n.createTexture(),a.memory.textures++)}if(A.samples>0&&We(A)===!1){O.__webglMultisampledFramebuffer=n.createFramebuffer(),O.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,O.__webglMultisampledFramebuffer);for(let ce=0;ce<Z.length;ce++){const me=Z[ce];O.__webglColorRenderbuffer[ce]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,O.__webglColorRenderbuffer[ce]);const qe=s.convert(me.format,me.colorSpace),ne=s.convert(me.type),ge=E(me.internalFormat,qe,ne,me.colorSpace,A.isXRRenderTarget===!0),Ae=Ge(A);n.renderbufferStorageMultisample(n.RENDERBUFFER,Ae,ge,A.width,A.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ce,n.RENDERBUFFER,O.__webglColorRenderbuffer[ce])}n.bindRenderbuffer(n.RENDERBUFFER,null),A.depthBuffer&&(O.__webglDepthRenderbuffer=n.createRenderbuffer(),re(O.__webglDepthRenderbuffer,A,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(Y){t.bindTexture(n.TEXTURE_CUBE_MAP,K.__webglTexture),te(n.TEXTURE_CUBE_MAP,v);for(let ce=0;ce<6;ce++)if(v.mipmaps&&v.mipmaps.length>0)for(let me=0;me<v.mipmaps.length;me++)he(O.__webglFramebuffer[ce][me],A,v,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,me);else he(O.__webglFramebuffer[ce],A,v,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0);g(v)&&p(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(xe){for(let ce=0,me=Z.length;ce<me;ce++){const qe=Z[ce],ne=i.get(qe);t.bindTexture(n.TEXTURE_2D,ne.__webglTexture),te(n.TEXTURE_2D,qe),he(O.__webglFramebuffer,A,qe,n.COLOR_ATTACHMENT0+ce,n.TEXTURE_2D,0),g(qe)&&p(n.TEXTURE_2D)}t.unbindTexture()}else{let ce=n.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(ce=A.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(ce,K.__webglTexture),te(ce,v),v.mipmaps&&v.mipmaps.length>0)for(let me=0;me<v.mipmaps.length;me++)he(O.__webglFramebuffer[me],A,v,n.COLOR_ATTACHMENT0,ce,me);else he(O.__webglFramebuffer,A,v,n.COLOR_ATTACHMENT0,ce,0);g(v)&&p(ce),t.unbindTexture()}A.depthBuffer&&ze(A)}function ht(A){const v=A.textures;for(let O=0,K=v.length;O<K;O++){const Z=v[O];if(g(Z)){const Y=T(A),xe=i.get(Z).__webglTexture;t.bindTexture(Y,xe),p(Y),t.unbindTexture()}}}const Ve=[],L=[];function Zt(A){if(A.samples>0){if(We(A)===!1){const v=A.textures,O=A.width,K=A.height;let Z=n.COLOR_BUFFER_BIT;const Y=A.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,xe=i.get(A),ce=v.length>1;if(ce)for(let me=0;me<v.length;me++)t.bindFramebuffer(n.FRAMEBUFFER,xe.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+me,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,xe.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+me,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,xe.__webglMultisampledFramebuffer),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,xe.__webglFramebuffer);for(let me=0;me<v.length;me++){if(A.resolveDepthBuffer&&(A.depthBuffer&&(Z|=n.DEPTH_BUFFER_BIT),A.stencilBuffer&&A.resolveStencilBuffer&&(Z|=n.STENCIL_BUFFER_BIT)),ce){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,xe.__webglColorRenderbuffer[me]);const qe=i.get(v[me]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,qe,0)}n.blitFramebuffer(0,0,O,K,0,0,O,K,Z,n.NEAREST),l===!0&&(Ve.length=0,L.length=0,Ve.push(n.COLOR_ATTACHMENT0+me),A.depthBuffer&&A.resolveDepthBuffer===!1&&(Ve.push(Y),L.push(Y),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,L)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,Ve))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),ce)for(let me=0;me<v.length;me++){t.bindFramebuffer(n.FRAMEBUFFER,xe.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+me,n.RENDERBUFFER,xe.__webglColorRenderbuffer[me]);const qe=i.get(v[me]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,xe.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+me,n.TEXTURE_2D,qe,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,xe.__webglMultisampledFramebuffer)}else if(A.depthBuffer&&A.resolveDepthBuffer===!1&&l){const v=A.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[v])}}}function Ge(A){return Math.min(r.maxSamples,A.samples)}function We(A){const v=i.get(A);return A.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function Me(A){const v=a.render.frame;u.get(A)!==v&&(u.set(A,v),A.update())}function at(A,v){const O=A.colorSpace,K=A.format,Z=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||O!==Ct&&O!==pi&&(He.getTransfer(O)===nt?(K!==sn||Z!==ni)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",O)),v}function ye(A){return typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement?(c.width=A.naturalWidth||A.width,c.height=A.naturalHeight||A.height):typeof VideoFrame<"u"&&A instanceof VideoFrame?(c.width=A.displayWidth,c.height=A.displayHeight):(c.width=A.width,c.height=A.height),c}this.allocateTextureUnit=F,this.resetTextureUnits=z,this.setTexture2D=q,this.setTexture2DArray=G,this.setTexture3D=j,this.setTextureCube=H,this.rebindTextures=be,this.setupRenderTarget=pt,this.updateRenderTargetMipmap=ht,this.updateMultisampleRenderTarget=Zt,this.setupDepthRenderbuffer=ze,this.setupFrameBufferTexture=he,this.useMultisampledRTT=We}function YM(n,e){function t(i,r=pi){let s;const a=He.getTransfer(r);if(i===ni)return n.UNSIGNED_BYTE;if(i===Bc)return n.UNSIGNED_SHORT_4_4_4_4;if(i===kc)return n.UNSIGNED_SHORT_5_5_5_1;if(i===cd)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===od)return n.BYTE;if(i===ld)return n.SHORT;if(i===ys)return n.UNSIGNED_SHORT;if(i===Oc)return n.INT;if(i===Gi)return n.UNSIGNED_INT;if(i===xn)return n.FLOAT;if(i===Cs)return n.HALF_FLOAT;if(i===ud)return n.ALPHA;if(i===hd)return n.RGB;if(i===sn)return n.RGBA;if(i===fd)return n.LUMINANCE;if(i===dd)return n.LUMINANCE_ALPHA;if(i===Er)return n.DEPTH_COMPONENT;if(i===Dr)return n.DEPTH_STENCIL;if(i===zc)return n.RED;if(i===Hc)return n.RED_INTEGER;if(i===pd)return n.RG;if(i===Vc)return n.RG_INTEGER;if(i===Gc)return n.RGBA_INTEGER;if(i===Ma||i===Sa||i===Ea||i===Ta)if(a===nt)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===Ma)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Sa)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Ea)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Ta)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===Ma)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Sa)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Ea)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Ta)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Ll||i===Dl||i===Il||i===Nl)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===Ll)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Dl)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Il)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Nl)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Ul||i===Fl||i===Ol)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===Ul||i===Fl)return a===nt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===Ol)return a===nt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===Bl||i===kl||i===zl||i===Hl||i===Vl||i===Gl||i===Wl||i===Xl||i===ql||i===Yl||i===jl||i===Kl||i===$l||i===Zl)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===Bl)return a===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===kl)return a===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===zl)return a===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Hl)return a===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Vl)return a===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Gl)return a===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Wl)return a===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Xl)return a===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===ql)return a===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Yl)return a===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===jl)return a===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Kl)return a===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===$l)return a===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Zl)return a===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===ba||i===Jl||i===Ql)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===ba)return a===nt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Jl)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Ql)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===md||i===ec||i===tc||i===nc)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===ba)return s.COMPRESSED_RED_RGTC1_EXT;if(i===ec)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===tc)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===nc)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Lr?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}const jM=`
void main() {
